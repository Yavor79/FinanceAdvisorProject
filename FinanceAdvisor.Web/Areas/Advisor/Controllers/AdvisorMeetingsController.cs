...
{
    public class AdvisorMeetingsController : AdvisorBaseController
    {
        private readonly ILogger<AdvisorMeetingsController> _logger;

        public AdvisorMeetingsController(
            IHttpClientFactory httpClientFactory,
            IMapper mapper,
            ITokenRefreshService tokenService,
            ILogger<AdvisorMeetingsController> logger)
